...
const DDL_MYSQL = [
  ...
  `CREATE TABLE IF NOT EXISTS internships (
    ...
    duration VARCHAR(512) NOT NULL DEFAULT '',
    stipend VARCHAR(512) NOT NULL DEFAULT 'Unpaid',
    application_fee DOUBLE NOT NULL DEFAULT 0,
    joining_fee DOUBLE NOT NULL DEFAULT 0,
  ...
  `CREATE TABLE IF NOT EXISTS internship_applications (
    ...
    user_id VARCHAR(191) NOT NULL,
    amount DOUBLE NOT NULL DEFAULT 0,
    payment_id VARCHAR(512) NOT NULL DEFAULT '',
    paid_at DATETIME,
    joining_fee_amount DOUBLE NOT NULL DEFAULT 0,
    joining_fee_payment_id VARCHAR(512) NOT NULL DEFAULT '',
    joining_fee_paid_at DATETIME,
    resume_url VARCHAR(2048) NOT NULL DEFAULT '',
    cover_letter TEXT NOT NULL,
    status VARCHAR(20) NOT NULL DEFAULT 'pending',
    offer_letter_url VARCHAR(2048) NOT NULL DEFAULT '',
    offer_sent_at DATETIME,
    admin_note TEXT NOT NULL,
    applied_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT internship_apps_internship_fk FOREIGN KEY (internship_id) REFERENCES internships(id) ON DELETE CASCADE,
    CONSTRAINT internship_apps_user_fk FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE
  )`,
  `CREATE TABLE IF NOT EXISTS internship_tasks (
    ...
    submission_url VARCHAR(2048) NOT NULL DEFAULT '',
    admin_feedback TEXT NOT NULL,
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT internship_tasks_app_fk FOREIGN KEY (application_id) REFERENCES internship_applications(id) ON DELETE CASCADE,
    CONSTRAINT internship_tasks_internship_fk FOREIGN KEY (internship_id) REFERENCES internships(id) ON DELETE CASCADE,
    CONSTRAINT internship_tasks_user_fk FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE
  )`,
]
...
const ADDITIVE_MYSQL = [
  ...
  `ALTER TABLE lessons ADD COLUMN IF NOT EXISTS pdf_description TEXT NOT NULL`,
  ...
  `ALTER TABLE internships ADD COLUMN IF NOT EXISTS joining_fee DOUBLE NOT NULL DEFAULT 0`,
  `ALTER TABLE internship_applications ADD COLUMN IF NOT EXISTS joining_fee_amount DOUBLE NOT NULL DEFAULT 0`,
  `ALTER TABLE internship_applications ADD COLUMN IF NOT EXISTS joining_fee_payment_id VARCHAR(512) NOT NULL DEFAULT ''`,
  `ALTER TABLE internship_applications ADD COLUMN IF NOT EXISTS joining_fee_paid_at DATETIME`,
  `ALTER TABLE internship_applications ADD COLUMN IF NOT EXISTS offer_letter_url VARCHAR(2048) NOT NULL DEFAULT ''`,
  `ALTER TABLE internship_applications ADD COLUMN IF NOT EXISTS offer_sent_at DATETIME`,
  ...
  `CREATE TABLE IF NOT EXISTS payouts (
    ...
    payment_ref VARCHAR(512) NOT NULL DEFAULT '',
    note TEXT NOT NULL,
    paid_by VARCHAR(191) NOT NULL,
    paid_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT payouts_paid_by_fk FOREIGN KEY (paid_by) REFERENCES users(id) ON DELETE CASCADE
  )`,
]
